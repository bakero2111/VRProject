...
public partial class @XRIDefaultInputActions: IInputActionCollection2, IDisposable
{
        ...
        },
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""BotonPrimarioX"",
                    ""type"": ""Value"",
                    ""id"": ""44b3e015-82bd-435e-92aa-5b8c2440a31a"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": true
                },
                {
                    ""name"": ""2"",
                    ""type"": ""Value"",
                    ""id"": ""fadfdd0a-d22c-4c48-83a0-aacd6a9ff0df"",
                    ""expectedControlType"": ""Vector3"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": true
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""251e65f2-7d48-4cb4-91f8-f7812bcbbc60"",
                    ""path"": ""<XRController>{LeftHand}/{IndexTouch}"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""Generic XR Controller"",
                    ""action"": ""BotonPrimarioX"",
                    ""isComposite"": false,
                    ""isPartOfComposite"": false
                },
                {
                    ""name"": """",
                    ""id"": ""eb288c9b-c2a6-4288-a843-70172f9371ac"",
                    ""path"": ""<XRController>{LeftHand}/devicePosition"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""Generic XR Controller"",
        ...
        },
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""botonPrimario"",
                    ""type"": ""Value"",
                    ""id"": ""e93a6cab-4a36-4009-8e5f-07e63075aea0"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": true
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""be654e8e-3bea-4cf5-990b-be34fbf2f3bb"",
                    ""path"": ""<XRController>{LeftHand}/primaryButton"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""Generic XR Controller"",
                    ""action"": ""botonPrimario"",
                    ""isComposite"": false,
                    ""isPartOfComposite"": false
                }
            ]
    ...
    ""controlSchemes"": [
        ...
        m_XRILeftHand_BotonPrimarioX = m_XRILeftHand.FindAction("BotonPrimarioX", throwIfNotFound: true);
        m_XRILeftHand__2 = m_XRILeftHand.FindAction("2", throwIfNotFound: true);
        ...
        m_XRILeftHandInteraction_botonPrimario = m_XRILeftHandInteraction.FindAction("botonPrimario", throwIfNotFound: true);
    ...
    private readonly InputAction m_XRILeftHand_BotonPrimarioX;
    private readonly InputAction m_XRILeftHand__2;
    public struct XRILeftHandActions
    {
        ...
        public InputAction @BotonPrimarioX => m_Wrapper.m_XRILeftHand_BotonPrimarioX;
        public InputAction @_2 => m_Wrapper.m_XRILeftHand__2;
        ...
        public void AddCallbacks(IXRILeftHandActions instance)
        {
            ...
            @BotonPrimarioX.started += instance.OnBotonPrimarioX;
            @BotonPrimarioX.performed += instance.OnBotonPrimarioX;
            @BotonPrimarioX.canceled += instance.OnBotonPrimarioX;
    ...
    private readonly InputAction m_XRILeftHandInteraction_botonPrimario;
    public struct XRILeftHandInteractionActions
    {
        ...
        public InputAction @botonPrimario => m_Wrapper.m_XRILeftHandInteraction_botonPrimario;
        ...
        public void AddCallbacks(IXRILeftHandInteractionActions instance)
        {
            ...
            @botonPrimario.started += instance.OnBotonPrimario;
            @botonPrimario.performed += instance.OnBotonPrimario;
            @botonPrimario.canceled += instance.OnBotonPrimario;
        }
    ...
    public interface IXRILeftHandActions
    {
        ...
        void OnBotonPrimarioX(InputAction.CallbackContext context);
    ...
    public interface IXRILeftHandInteractionActions
    {
        ...
        void OnBotonPrimario(InputAction.CallbackContext context);
    }
